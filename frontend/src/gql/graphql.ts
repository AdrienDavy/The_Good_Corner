...
export type AdQuery = { __typename?: 'Query', ad?: { __typename?: 'Ad', createdAt: any, description?: string | null, id: string, location: string, picture: string, price: number, title: string, createdBy: { __typename?: 'User', id: string, email?: string | null }, category: { __typename?: 'Category', id: string, name: string }, tags: Array<{ __typename?: 'Tag', id: string, name: string }> } | null };

export type AdsQueryVariables = Exact<{ [key: string]: never; }>;


export type AdsQuery = { __typename?: 'Query', ads: Array<{ __typename?: 'Ad', id: string, picture: string, title: string, price: number, createdAt: any, createdBy: { __typename?: 'User', id: string, email?: string | null }, category: { __typename?: 'Category', id: string, name: string } }> };
