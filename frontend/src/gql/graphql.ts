...
export type AdsQuery = { __typename?: 'Query', ads: Array<{ __typename?: 'Ad', id: string, picture: string, title: string, price: number, owner: string, createdAt: any, category: { __typename?: 'Category', id: string, name: string } }> };
...
export type CategoryQuery = { __typename?: 'Query', category?: { __typename?: 'Category', id: string, name: string, ads: Array<{ __typename?: 'Ad', id: string, title: string, picture: string, price: number, description?: string | null, owner: string, location: string, createdAt: any, tags: Array<{ __typename?: 'Tag', id: string, name: string }>, category: { __typename?: 'Category', id: string, name: string } }> } | null };
